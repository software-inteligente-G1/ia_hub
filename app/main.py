...
from app.routers import genetic, naive_bayes, energy_router, mental_health, fruit_router
...
app.include_router(fruit_router.router, prefix="/fruit", 
                   tags=["Fruit Classification"])
